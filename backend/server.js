...
.connect('mongodb+srv://anime:anime1234@animeproyecto.tlk4v.mongodb.net/animeProyecto?retryWrites=true&w=majority')
.then((x) => {
...
app.use(cors());
app.use(express.static(path.join(__dirname,'dist/anime')));
app.use("/",express.static(path.join(__dirname,'dist/anime')));
